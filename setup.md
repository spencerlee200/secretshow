...
You may want to create a new user that just has control over uploading and editing your project. To do this all you have to do is create a new user and assign them nginx `www-data` permissions with their projects name.Then you can use this new user in the deployment pipeline you create later.
